...
@pytest.mark.parametrize("cards, the_sum, is_hard", [
    ...
    ([Card("3"), Card("10")], 13, True),
    ([Card("3"), Card("4"), Card("5")], 12, True),
    ([Card("10"), Card("10")], 20, True),
    ([Card("10"), Card("10"), Card("2")], 22, True),
    ([Card("8"), Card("8"), Card("A")], 17, True),
    ([Card("A"), Card("10"), Card("A")], 12, True),
    # Soft hands (Ace counts as 11)
    ([Card("A"), Card("2")], 13, False),
    ([Card("A"), Card("A"), Card("2")], 14, False),
    ([Card("A"), Card("8")], 19, False),
    ([Card("A"), Card("K")], 21, False),
    ([Card("A"), Card("9")], 20, False),
    ([Card("A"), Card("A"), Card("9")], 21, False),
])
